...
# Init
	...
	Else {
		$runDateObj = Get-Date -Date $runDate -ErrorAction Stop
	}
	$startTime = Get-Date
	$startTimeText = $(Create-TimeStamp -forFileName)
	$day = $runDateObj.day.ToString("00")
	$month = $runDateObj.month.ToString("00")
