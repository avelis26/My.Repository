...
sudo sh -c "echo 'UUID=23d0662c-d2b9-490b-9b01-6a9fe21a3d08	/media/data	ext4	defaults,nofail	1	2' >> /etc/fstab"
...
sudo mkdir -p /media/data/sfcc/outbound
sudo chown -R root:root /media/data/sfcc
sudo chown databasescvs:sftpadmins /media/data/sfcc/inbound
sudo chown databasescvs:sftpadmins /media/data/sfcc/outbound
sudo chmod 775 /media/data/sfcc/inbound
sudo chmod 775 /media/data/sfcc/outbound
